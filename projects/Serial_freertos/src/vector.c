...
/** \brief System Tick Handler la hago extern porque la voy a definir en mi OS */
extern void SysTick_Handler(void);

/*Agrego esta interrupción*/
...
void (* const g_pfnVectors[])(void) = {
   ...
   ISR_Evento,      /* 0x2a 0x000000A8 - No Handler set for ISR UART2 (IRQ 26) */
...
/*Las elimino porque las voy a definir en mi sistema operativo*/
/*
__attribute__ ((section(".after_vectors")))
